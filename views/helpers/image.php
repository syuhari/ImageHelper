 ...
 */
	function resize($path, $width, $height, $aspect = true, $htmlAttributes = array(), $return = false) {
		...
		$relfile = $this->webroot.$this->themeWeb.IMAGES_URL.$this->cacheDir.'/'.$width.'x'.$height.'_'.$cache_name; // relative file
		$cachefile = $fullpath.$this->cacheDir.DS.$width.'x'.$height.'_'.$cache_name;  // location on server
